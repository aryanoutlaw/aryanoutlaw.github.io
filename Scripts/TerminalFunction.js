...
function BootSequence()
{
    ...
    if (Time > 1.1) {OutputsText += "Welcome to Aryan-OS 2.9.0 x86_64\n";}
...
const FileSystem = {
    "root": {type: "directory", contents: {
        "projects": {type: "directory", contents: {
            "projects.txt": {type: "file", content: `Selection of my core ML engineering projects demonstrating
full-stack AI development capabilities from research to deployment.
These projects showcase my expertise in computer vision, deep learning,
and real-time system development.`},
            
            "multimodal_sentiment.lnk": {type: "link", content: "https://github.com/aryanoutlaw/Multimodal-Sentiment-Analysis"},
            "tennis_analysis.lnk": {type: "link", content: "https://github.com/aryanoutlaw/Tennis-Analytics"},
            "sign_language.lnk": {type: "link", content: "https://github.com/aryanoutlaw/SignLanguage-Recognition"},
            "radar_classification.lnk": {type: "link", content: "https://github.com/aryanoutlaw/Radar-Classification"},
        }},

        "about.txt": {type: "file", content: 
`AI Engineer with strong expertise in computer vision 
and deep learning,demonstrated through multiple 
multimodal projects. Proficient in developing
end-to-end machine learning systems with focus 
on real-time processing and deployment. Skilled 
in PyTorch, TensorFlow, and MLOps tools.

Technical Skills:
- Core ML/DL: PyTorch, TensorFlow, 
              Scikit-learn, Computer Vision, NLP
- Languages: Python, Java, C ]
- Deep Learning: CNN, LSTM, Transformers, BERT, 
- MLOps: FastAPI, Streamlit, Hugging Face Inference`},

        "education.txt": {type: "file", content: `Noida Institute of Engineering and Technology
B.Tech in Computer Science (AI & ML)
CGPA: 8.55/10.0 (6th Semester)
...
- PyTorch for Deep Learning Bootcamp (Udemy)`},
        ...
        "experience.txt": {type: "file", content: 
`While I don't have formal industry experience yet, 
my project portfolio demonstrates strong practical 
skills in AI/ML development:

- Developed multimodal AI systems combining computer 
  vision and NLP
- Built real-time processing pipelines with 
  optimization for deployment
- Created end-to-end machine learning solutions from 
  data processing to model deployment
- Experience with both research (model development) 
and production (Streamlit/FastAPI deployment) aspects 
of AI systems`},
